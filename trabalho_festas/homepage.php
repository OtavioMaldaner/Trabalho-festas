...
<table>
    <tr>
        <td>
            Nome
            <a href="homepage.php?coluna=nome&tipo=ASC">Ascendente</a>
            <a href="homepage.php?coluna=nome&tipo=DESC">Decrescente</a>
        </td>
        <td>
            Endereço
            <a href="homepage.php?coluna=endereco&tipo=ASC">Ascendente</a>
            <a href="homepage.php?coluna=endereco&tipo=DESC">Decrescente</a>
        </td>
        <td>
            Cidade
            <a href="homepage.php?coluna=cidade&tipo=ASC">Ascendente</a>
            <a href="homepage.php?coluna=cidade&tipo=DESC">Decrescente</a>
        </td>
        <td>
            Data
            <a href="homepage.php?coluna=data&tipo=ASC">Ascendente</a>
            <a href="homepage.php?coluna=data&tipo=DESC">Decrescente</a>
        </td>
    </tr>
    <?php
    $coluna = $_GET['coluna'];
